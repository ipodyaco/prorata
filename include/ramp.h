...
// this is removed for MinGW compilation
...
// this is for compilation with Visual C++
//typedef _int64 ramp_fileoffset_t;
// this is for compilation with MinGW
...
typedef off_t ramp_fileoffset_t;
#define ramp_fseek(a,b,c) fseek(a->fileHandle,b,c)
#define ramp_ftell(a) ftell(a->fileHandle)
